...
__all__ = [
    'eLEXTYPE_RESERVED10', 'STSF_LocalAppData', 'SRTReSent',
    'DISPID_SpeechDataKey', 'DISPID_SpeechVoiceEvent',
    'IInternetSecurityMgrSite', 'SPEI_RECO_OTHER_CONTEXT',
    'DISPID_SAStatus', 'SPSMF_SAPI_PROPERTIES', 'SGDSInactive',
    ...
    'SPDKL_CurrentUser', 'DISPID_SpeechLexiconWord', 'SITooFast',
    'SSFMOpenForRead', 'DISPID_SRCEBookmark',
    'DISPID_SDKGetStringValue', 'SAFTNoAssignedFormat', 'SVSFDefault',
    'SVP_18', 'DISPID_SOTGetStorageFileName', 'DISPID_SGRAttributes',
    'SPVPRIORITY', 'SpNotifyTranslator',
    'DISPID_SpeechPhraseProperty', 'SPRECOSTATE',
    'DISPID_SPAPhraseInfo', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'SVEBookmark', 'ISpRecoGrammar2', 'SITooLoud', 'DISPID_SGRSTRule',
    'SP_VISEME_13', 'DISPID_SRStatus', 'SP_VISEME_7',
    'DISPID_SWFEFormatTag', 'IEnumSpObjectTokens',
    ...
    'SGPronounciation', 'IEnumString', 'SWTAdded', 'SPBO_AHEAD',
    'SDKLDefaultLocation', 'DISPID_SGRSTransitions',
    'DISPID_SASFreeBufferSpace', 'SRAImport', 'SDTAlternates',
    'DISPID_SWFESamplesPerSec', 'SPSHT_EMAIL',
    'DISPID_SPEEngineConfidence', 'SVSFUnusedFlags', 'ISpeechVoice',
    'SPCT_SLEEP', 'SPSVerb', 'SGRSTTWildcard',
    'DISPID_SVSpeakCompleteEvent', 'SpeechStreamFileMode',
    'SpeechGrammarTagWildcard', 'SPWORDPRONUNCIATION',
    'DISPIDSPTSI_SelectionLength', 'SpResourceManager',
    'DISPID_SPPParent', 'SPAUDIOSTATE', 'DISPID_SVGetVoices',
    'SpeechRecognitionType', 'Speech_Max_Pron_Length', 'SPAS_PAUSE',
    'ISpResourceManager', 'DISPID_SPPsCount',
    'SWPUnknownWordUnpronounceable', 'DISPID_SVPause',
    'SAFT11kHz8BitMono', 'DISPID_SRRSpeakAudio',
    ...
    'DISPID_SADefaultFormat', 'DISPID_SLGenerationId',
    'SDTReplacement', 'SAFTCCITT_ALaw_11kHzMono', 'SRERecognition',
    'SpeechEmulationCompareFlags', 'DISPID_SPCIdToPhone',
    'DISPID_SVEStreamEnd', 'SVEPrivate', 'ISpeechLexicon',
    'DISPID_SRGReset', 'ISpeechPhoneConverter',
    'DISPID_SpeechLexiconWords', 'SPEI_PROPERTY_STRING_CHANGE',
    'SVSFIsNotXML', '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'DISPID_SASCurrentDevicePosition', 'SPBO_TIME_UNITS',
    'DISPID_SPRsCount', 'ISpNotifySource', 'SPPS_Unknown',
    'SPPS_SuppressWord', 'SGLexical', 'SREBookmark',
    'eLEXTYPE_PRIVATE4', 'SPPS_RESERVED1', 'SPPS_Noncontent',
    'SPWORDPRONOUNCEABLE', 'SpObjectToken',
    'DISPID_SAFSetWaveFormatEx', 'SAFT16kHz8BitMono',
    'SGRSTTDictation', 'SVP_20', 'SP_VISEME_4',
    'DISPID_SDKGetBinaryValue', 'SpeechTokenShellFolder',
    'eLEXTYPE_PRIVATE10', 'ISpeechCustomStream', 'ISpObjectWithToken',
    'DISPID_SRCEAudioLevel', 'DISPID_SVSPhonemeId',
    'SAFTCCITT_ALaw_8kHzStereo', 'DISPID_SpeechWaveFormatEx',
    'DISPID_SVPriority', 'SPEI_MAX_TTS', 'SPAUDIOBUFFERINFO',
    'ISpeechPhraseProperties', 'DISPID_SVSInputWordLength',
    'SPPS_RESERVED2', 'DISPID_SpeechGrammarRule', 'SP_VISEME_5',
    'DISPID_SRGRules', 'SpVoice', 'eLEXTYPE_MORPHOLOGY',
    'DISPID_SWFEChannels', 'SPBO_PAUSE', 'SP_VISEME_20',
    'DISPID_SVSLastBookmarkId', 'SPPS_Noun', 'SPINTERFERENCE_NOISE',
    'SECFIgnoreKanaType', 'SPCT_DICTATION',
    'DISPID_SpeechPhraseRules', 'ISpShortcut', 'DISPID_SRGId',
    'SpeechGrammarTagUnlimitedDictation', 'ISpeechAudioBufferInfo',
    'SAFT32kHz8BitMono', 'SpeechVoicePriority',
    'SpeechGrammarWordType', 'SpMemoryStream', 'ISpRecognizer',
    'DISPID_SVSpeak', 'SREPropertyNumChange', 'eLEXTYPE_PRIVATE1',
    'SVEVoiceChange', 'DISPID_SGRId', 'tagSPTEXTSELECTIONINFO',
    'SPPS_Modifier', 'SpeechVisemeFeature',
    'DISPID_SVGetAudioOutputs', 'DISPID_SpeechVoiceStatus',
    'DISPID_SMSAMMHandle', 'SAFT44kHz8BitMono', 'SDTLexicalForm',
    'SP_VISEME_6', 'SPPS_Interjection', 'DISPID_SRCEAdaptation',
    'SDA_Consume_Leading_Spaces', 'SAFT24kHz16BitStereo',
    'DISPID_SRCState', 'ISpeechBaseStream', 'SDA_One_Trailing_Space',
    'DISPID_SBSFormat', 'SAFTCCITT_uLaw_11kHzMono',
    'SSSPTRelativeToStart', 'DISPID_SpeechMMSysAudio',
    'DISPID_SVEPhoneme', 'SRCS_Disabled', 'SPPHRASEREPLACEMENT',
    'SP_VISEME_10', 'DISPID_SRRAlternates',
    'DISPID_SOTGetDescription', 'STCLocalServer', 'DISPID_SAFType',
    'SpeechCategoryAppLexicons', '_ISpeechRecoContextEvents',
    'DISPID_SRRTOffsetFromStart', 'ISpeechPhraseInfo',
    'ISpNotifyTranslator', 'SPPS_RESERVED4', 'DISPID_SGRSTs_NewEnum',
    'ISpPhrase', 'DISPID_SAEventHandle', 'SAFT44kHz16BitMono',
    'SDA_No_Trailing_Space', 'eLEXTYPE_PRIVATE13',
    'SpeechVoiceSkipTypeSentence', 'SAFT44kHz16BitStereo',
    'SDTPronunciation', 'SDTDisplayText',
    'SpeechRetainedAudioOptions', 'SPFM_NUM_MODES',
    'SpeechPropertyResourceUsage', 'DISPID_SVAudioOutput',
    'SREPrivate', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'SpeechTokenKeyFiles', 'eLEXTYPE_RESERVED6', 'ISpeechRecoContext',
    'DISPID_SOTGetAttribute', 'SAFTCCITT_ALaw_11kHzStereo',
    'SAFTADPCM_22kHzMono', 'SPFILEMODE', 'SPCT_SUB_DICTATION',
    'DISPID_SVWaitUntilDone', 'DISPID_SPEDisplayAttributes',
    'SAFT16kHz16BitMono', '_ISpeechVoiceEvents',
    'DISPID_SRCRecognizer', 'DISPID_SVEStreamStart', 'SECFIgnoreCase',
    'SpeechUserTraining', 'DISPID_SRCCmdMaxAlternates',
    'SpeechRunState', 'SVP_5', 'SPSEMANTICERRORINFO',
    'DISPID_SLPs_NewEnum', 'DISPID_SPISaveToMemory',
    'SPFM_OPEN_READWRITE', 'SDKLLocalMachine',
    'DISPID_SPRuleEngineConfidence', 'SAFTCCITT_uLaw_8kHzStereo',
    'DISPID_SGRSTType', 'SWPKnownWordPronounceable', 'SP_VISEME_21',
    'SSFMOpenReadWrite', 'SLTUser', 'SPEVENTSOURCEINFO',
    'SPRS_INACTIVE', 'DISPID_SPRulesCount', 'SAFTADPCM_44kHzMono',
    'DISPID_SRRAudio', 'SVP_16', 'SPAR_Unknown',
    'ISpeechObjectTokenCategory', 'DISPID_SGRsDynamic',
    'SPPROPERTYINFO', 'DISPID_SDKSetLongValue', 'SPEVENTENUM',
    'DISPID_SVESentenceBoundary', 'DISPID_SPIAudioSizeTime',
    'DISPID_SpeechPhraseElement', 'SRERequestUI', 'SPAS_CLOSED',
    'ISpeechMemoryStream', '_SPAUDIOSTATE', 'SpInprocRecognizer',
    'DISPID_SPAStartElementInResult', 'SPWF_SRENGINE',
    'DISPID_SpeechRecoContext', 'eLEXTYPE_PRIVATE12',
    'SAFT12kHz16BitMono', 'SP_VISEME_3', 'SPDKL_LocalMachine',
    'eLEXTYPE_VENDORLEXICON', 'ISpeechObjectToken',
    'DISPID_SRCESoundStart', 'SpeechVisemeType', 'SASClosed',
    'SAFT8kHz8BitStereo', 'SpMMAudioIn', 'DISPID_SOTCreateInstance',
    'SAFT22kHz8BitMono', 'SPRECORESULTTIMES', 'DISPID_SVEVoiceChange',
    'SPPHRASERULE', 'ISpeechResourceLoader', 'DISPID_SLPPartOfSpeech',
    'SpeechGrammarState', 'DISPID_SVEEnginePrivate',
    'ISpeechPhraseInfoBuilder', 'SpeechStreamSeekPositionType',
    'SPEI_ADAPTATION', 'ISpeechPhraseAlternates', 'SVP_14',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SP_VISEME_11',
    'DISPID_SOTs_NewEnum', 'ISpObjectTokenCategory', 'SRAExport',
    'SAFTADPCM_8kHzMono', 'SPEI_RESERVED2',
    'DISPID_SPEAudioStreamOffset', 'ISpeechPhraseRule',
    'DISPID_SLPPhoneIds', 'DISPID_SRGCommit', 'ISpeechRecognizer',
    'DISPID_SRGetPropertyString', 'SPEI_END_INPUT_STREAM',
    'SFTSREngine', 'SPPHRASE',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SPSFunction',
    'SPSModifier', 'DISPID_SOTRemove', 'SREPhraseStart',
    'SPGRAMMARWORDTYPE', 'DISPID_SGRSTsCount', 'SDTAudio',
    'SPEI_RESERVED1', 'DISPID_SpeechObjectTokenCategory',
    'DISPID_SPACommit', 'SVP_2', 'DISPID_SVEventInterests',
    'ISpeechRecoGrammar', 'DISPID_SRGCmdSetRuleState',
    'SRSActiveAlways', 'SPEI_SOUND_START',
    ...
    'DISPID_SWFEAvgBytesPerSec', 'SVESentenceBoundary', 'ISpLexicon',
    'eLEXTYPE_PRIVATE8', 'DISPID_SRRGetXMLErrorInfo', 'SVP_13',
    'STCRemoteServer', 'SVSFPurgeBeforeSpeak',
    'SpeechRegistryUserRoot', 'SPWT_PRONUNCIATION',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'SPINTERFERENCE_NOSIGNAL', 'SAFTADPCM_11kHzStereo',
    'ISpStreamFormatConverter', 'SVP_19', 'SpeechInterference',
    'DISPID_SGRSTWeight', 'DISPID_SRCAudioInInterferenceStatus',
    'SPEI_RESERVED3', 'DISPID_SRGRecoContext', 'SRTEmulated',
    'ISpRecognizer3', 'DISPID_SPIStartTime', 'DISPID_SVSLastResult',
    'DISPID_SGRName', 'ISpeechVoiceStatus',
    'SpeechTokenKeyAttributes', 'SINoise', 'DISPID_SPIElements',
    'ISpeechRecoResult', 'DISPID_SpeechRecognizer',
    'SPFM_CREATE_ALWAYS', 'SP_VISEME_17',
    'DISPID_SOTCEnumerateTokens', 'DISPID_SRCCreateResultFromMemory',
    'DISPID_SBSWrite', 'SpObjectTokenCategory',
    'ISpeechXMLRecoResult', 'SPFM_CREATE', 'DISPID_SpeechPhraseRule',
    'DISPID_SOTCategory', 'SPEI_PROPERTY_NUM_CHANGE', 'SPEI_VISEME',
    'SPPS_NotOverriden', 'ISpPhraseAlt', 'SPCONTEXTSTATE',
    'DISPID_SPEAudioSizeTime', 'SVP_17', 'SPWORDPRONUNCIATIONLIST',
    'SREStateChange', 'SPDKL_CurrentConfig',
    'SPINTERFERENCE_LATENCY_WARNING', 'DISPID_SGRsCount',
    'SVEAudioLevel', 'SGDSActive', 'SPVISEMES',
    'SPSMF_SRGS_SAPIPROPERTIES', 'DISPID_SVEBookmark',
    'ISpPhoneConverter', 'ISpXMLRecoResult',
    'DISPID_SRCERecognizerStateChange', 'SpeechCategoryRecognizers',
    'ISpRecoContext2', 'DISPID_SPAsItem',
    'DISPID_SRGCmdSetRuleIdState', 'SPLEXICONTYPE', 'DISPID_SAFGuid',
    'DISPID_SRCEHypothesis', 'SpeechVoiceSpeakFlags',
    'DISPID_SRCSetAdaptationData',
    'SpeechPropertyNormalConfidenceThreshold', 'SP_VISEME_1',
    'DISPID_SpeechGrammarRuleState', 'SAFTCCITT_uLaw_44kHzMono',
    'SAFTCCITT_uLaw_11kHzStereo', 'UINT_PTR', 'DISPID_SRAudioInput',
    'SPAR_High', 'SPSHT_OTHER', 'SPWORDTYPE',
    'SpPhoneticAlphabetConverter', 'SVSFNLPMask', 'SPEI_MIN_TTS',
    'DISPID_SGRsAdd', 'SpeechAudioVolume',
    'DISPID_SPPEngineConfidence', 'DISPID_SPRuleName',
    'DISPID_SRCEInterference', 'DISPID_SpeechGrammarRules',
    'SpCustomStream', 'DISPID_SpeechRecoResult',
    'SAFT8kHz16BitStereo', 'SpAudioFormat', 'SRTAutopause',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SPBOOKMARKOPTIONS',
    'DISPID_SLWsCount', 'DISPID_SWFEExtraData', 'SPPS_LMA',
    'DISPID_SpeechPhraseInfo', 'SpeechMicTraining',
    'DISPID_SWFEBlockAlign', 'ISpeechLexiconWords', 'DISPID_SGRSRule',
    'SVSFPersistXML', 'SPEI_START_INPUT_STREAM', 'eLEXTYPE_RESERVED9',
    'DISPIDSPTSI_ActiveLength', 'SAFTTrueSpeech_8kHz1BitMono',
    'SpCompressedLexicon', 'DISPID_SFSClose',
    'DISPID_SRSetPropertyString', 'DISPID_SVEViseme',
    'DISPID_SpeechAudioBufferInfo', 'DISPID_SPPFirstElement',
    'SpeechAudioProperties',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SVSRunningState', 'SWPUnknownWordPronounceable',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'eLEXTYPE_PRIVATE17',
    'SVEWordBoundary', 'SGRSTTTextBuffer', 'SAFTADPCM_8kHzStereo',
    'SRTStandard', 'ISpRecognizer2',
    'SpeechGrammarRuleStateTransitionType', 'DISPID_SFSOpen',
    'SRTSMLTimeout', 'DISPID_SRGCmdLoadFromFile', 'DISPID_SVVoice',
    'DISPID_SpeechCustomStream', 'SVP_21',
    'DISPID_SRGIsPronounceable', 'SP_VISEME_19',
    'ISpeechPhraseReplacements', 'SPINTERFERENCE_TOOQUIET',
    'SVF_Emphasis', 'DISPID_SRGCmdLoadFromObject',
    'SPSERIALIZEDPHRASE', 'DISPID_SMSALineId', 'SLOStatic',
    'DISPID_SGRs_NewEnum', 'DISPID_SRRecognizer',
    'SAFTGSM610_44kHzMono', 'SGRSTTEpsilon',
    'Speech_StreamPos_RealTime', 'DISPID_SPERequiredConfidence',
    'ISpProperties', 'DISPID_SOTCId', 'SAFT22kHz16BitStereo',
    'SPPS_RESERVED3', 'SRADefaultToActive', 'SpeechDisplayAttributes',
    'STCAll', 'DISPID_SPEAudioSizeBytes', 'DISPID_SRGState',
    'DISPID_SpeechPhraseElements', '_RemotableHandle', 'LONG_PTR',
    'SGDSActiveUserDelimited', 'SpInProcRecoContext',
    'DISPID_SpeechPhraseBuilder', 'ISpeechLexiconWord',
    'SPCS_DISABLED', 'DISPID_SGRSTPropertyName', 'ISpNotifySink',
    'SPEI_UNDEFINED', 'SGRSTTRule', 'DISPID_SPRText', 'SP_VISEME_14',
    'Speech_Default_Weight', 'DISPID_SASetState',
    'SAFTADPCM_22kHzStereo', 'DISPID_SBSRead', 'eLEXTYPE_PRIVATE20',
    'SAFT11kHz8BitStereo', 'SPEI_TTS_PRIVATE',
    'DISPID_SDKGetlongValue', 'SpeechRecoProfileProperties',
    'ISpeechPhraseAlternate', 'SAFTADPCM_11kHzMono',
    'SpPhraseInfoBuilder', 'DISPID_SGRClear',
    'DISPID_SRCEventInterests', 'IInternetSecurityManager',
    'SPRST_NUM_STATES', 'DISPID_SLWType', 'SPCT_COMMAND',
    'ISpDataKey', 'DISPID_SPRuleId', 'ISpeechLexiconPronunciation',
    'SVPNormal', 'DISPID_SRGSetWordSequenceData',
    'SRSInactiveWithPurge', 'DISPID_SRSetPropertyNumber',
    'SpeechCategoryAudioIn', 'DISPID_SVStatus', 'SPAO_RETAIN_AUDIO',
    ...
    'SPINTERFERENCE_TOOSLOW', 'SPVPRI_ALERT', 'DISPID_SGRsCommit',
    'SpeechWordType', 'SSTTWildcard', 'SPADAPTATIONRELEVANCE',
    'DISPID_SVSInputSentenceLength', 'ISpeechLexiconPronunciations',
    'SPDKL_DefaultLocation', 'DISPID_SRIsUISupported', 'SPWORDLIST',
    'SVP_9', 'eWORDTYPE_DELETED', 'SpeechAudioState',
    'DISPID_SLPLangId', 'DISPID_SOTDataKey', 'SpShortcut',
    'SWTDeleted', 'SVF_None', 'SPAR_Low', 'DISPID_SVSkip', 'SINone',
    'SPSHORTCUTTYPE', 'SITooSlow', 'SpeechWordPronounceable',
    'SPEI_VOICE_CHANGE', 'DISPID_SOTsCount', 'SLODynamic',
    'SVF_Stressed', 'SVP_0', 'SVP_11', 'SREFalseRecognition',
    'DISPID_SPPConfidence', 'SAFT22kHz8BitStereo',
    'DISPIDSPTSI_ActiveOffset', 'DISPID_SPCPhoneToId',
    'SSTTTextBuffer', 'eLEXTYPE_PRIVATE11', 'DISPID_SVVolume',
    'DISPID_SPRsItem', 'SBONone', 'DISPID_SpeechPhraseReplacements',
    'DISPID_SRSCurrentStreamPosition',
    'DISPID_SpeechPhraseAlternates', 'SECFNoSpecialChars',
    'SSSPTRelativeToCurrentPosition', 'SVP_6',
    'eLEXTYPE_USER_SHORTCUT', 'SPRECOCONTEXTSTATUS',
    'SPXRO_Alternates_SML', 'DISPID_SVSInputSentencePosition',
    'DISPID_SAFGetWaveFormatEx', 'SVSFIsXML',
    'DISPID_SRCCreateGrammar', 'DISPID_SOTCSetId', 'SRSEIsSpeaking',
    'DISPID_SLGetWords', 'SPAUDIOOPTIONS', 'SGLexicalNoSpecialChars',
    'ISpeechAudioStatus', 'SRCS_Enabled', 'SPEI_SR_BOOKMARK',
    'SPEI_END_SR_STREAM', 'SpeechAllElements', 'ISpAudio',
    'SPAR_Medium', 'SECFEmulateResult', 'DISPID_SRCESoundEnd',
    'DISPID_SOTsItem', 'DISPID_SpeechMemoryStream', 'SFTInput',
    'SPSLMA', 'DISPID_SPPId', 'SpWaveFormatEx', 'SVSFParseSapi',
    'DISPID_SRAudioInputStream', 'DISPID_SDKOpenKey',
    'DISPID_SPERetainedStreamOffset', 'SPRS_ACTIVE_USER_DELIMITED',
    'SAFT24kHz8BitMono', 'DISPID_SRCEPropertyStringChange',
    'ISpMMSysAudio', 'DISPID_SGRSAddRuleTransition',
    'DISPID_SPIAudioSizeBytes', 'eLEXTYPE_PRIVATE14',
    'DISPID_SPIEnginePrivateData', 'SAFT48kHz16BitStereo',
    'DISPID_SPEsCount', 'SVP_15', 'DISPID_SVSyncronousSpeakTimeout',
    'SPAUDIOSTATUS', 'SREStreamEnd', 'DISPID_SLAddPronunciation',
    'DISPID_SRCEStartStream',
    'DISPID_SLRemovePronunciationByPhoneIds',
    'DISPID_SGRSAddSpecialTransition', 'SPSHORTCUTPAIRLIST',
    'DISPID_SRCResume', 'SREAdaptation', 'SSFMCreate',
    'SpeechVoiceEvents', 'SGSEnabled', 'DISPID_SAVolume',
    'eLEXTYPE_PRIVATE15', 'SVP_8', 'ISpeechRecoResultDispatch',
    'DISPID_SLWPronunciations', 'DISPID_SABufferInfo',
    'DISPID_SCSBaseStream', 'ISpStream',
    'DISPID_SRCEFalseRecognition', 'SPEI_SR_AUDIO_LEVEL',
    'SPDATAKEYLOCATION', 'DISPID_SPEPronunciation',
    'SpeechPartOfSpeech', 'SASRun', 'tagSTATSTG', 'SpMMAudioOut',
    'eLEXTYPE_RESERVED7', 'SPRECOGNIZERSTATUS', 'SAFT12kHz8BitMono',
    'SAFTADPCM_44kHzStereo', 'SPSEMANTICFORMAT', 'SGRSTTWord',
    'SpeechLoadOption', 'DISPID_SVResume',
    'DISPID_SPRuleFirstElement', 'DISPID_SGRSTNextState',
    'SINoSignal', 'DISPID_SOTId', 'SPRS_ACTIVE',
    'DISPID_SpeechRecoResultTimes', 'DISPID_SRRSetTextFeedback',
    'SAFTCCITT_ALaw_44kHzStereo', 'SRTExtendableParse',
    'SpeechLexiconType', 'SPEVENT', 'ISpEventSource',
    'SPEI_REQUEST_UI', 'SpMMAudioEnum', 'DISPID_SPPName',
    'SAFT16kHz8BitStereo', 'SPWT_DISPLAY', 'STSF_FlagCreate',
    'SpeechDictationTopicSpelling', 'DISPID_SLGetGenerationChange',
    'DISPID_SDKSetStringValue', 'SPGS_DISABLED',
    'DISPID_SASNonBlockingIO', 'DISPID_SRSSupportedLanguages',
    'SAFTExtendedAudioFormat', 'DISPID_SRGetFormat',
    'eLEXTYPE_PRIVATE3', 'SPAS_RUN',
    'DISPID_SRCEPropertyNumberChange', 'ISpEventSink',
    'ISpeechRecoResult2', 'DISPID_SOTCGetDataKey', 'DISPID_SRCVoice',
    'DISPID_SpeechPhraseAlternate', 'DISPID_SPRFirstElement',
    'SVSFParseMask', 'DISPID_SMSSetData', 'DISPID_SPELexicalForm',
    'SLTApp', 'SPXRO_SML', 'SpeechCategoryPhoneConverters',
    'SGDisplay', 'SVEViseme', 'DISPID_SVSLastBookmark',
    'DISPID_SGRSAddWordTransition', 'DISPID_SPIEngineId',
    'SAFT32kHz16BitMono', 'SPEI_PHONEME', 'SDTProperty',
    'SpeechRuleState', 'DISPID_SRGCmdLoadFromMemory',
    'DISPID_SRGDictationLoad', 'DISPID_SRGDictationSetState',
    'DISPID_SLPsItem', 'SPEI_INTERFERENCE', 'DISPID_SPEDisplayText',
    'DISPID_SPRuleChildren', 'SpStreamFormatConverter',
    'DISPID_SVIsUISupported', 'DISPID_SMSADeviceId', 'SDTAll',
    'DISPID_SLWs_NewEnum', 'SVP_7', 'DISPID_SDKDeleteValue',
    'SPINTERFERENCE', 'DISPID_SVAudioOutputStream', 'DISPID_SBSSeek',
    'SPSNoun', 'ISpeechObjectTokens', 'DISPID_SLWsItem',
    'SAFT48kHz8BitMono', 'SPRST_ACTIVE', 'SpeechGrammarTagDictation',
    'ISpeechMMSysAudio', 'SAFTCCITT_ALaw_8kHzMono',
    'SpeechCategoryRecoProfiles', 'SPEI_TTS_AUDIO_LEVEL',
    'SPEI_FALSE_RECOGNITION', 'ISpGrammarBuilder', 'SP_VISEME_18',
    'SPRST_INACTIVE_WITH_PURGE', 'ISpRecoGrammar',
    'DISPID_SASCurrentSeekPosition', 'SPSHT_Unknown',
    'SPCT_SUB_COMMAND', 'DISPID_SpeechGrammarRuleStateTransitions',
    'SAFTGSM610_22kHzMono', 'SDTRule', 'DISPID_SDKEnumValues',
    'ISpObjectToken', 'DISPID_SRCERecognitionForOtherContext',
    'SP_VISEME_15', 'eLEXTYPE_PRIVATE6', 'SAFTCCITT_ALaw_22kHzStereo',
    'ISpStreamFormat', 'SGSDisabled', 'DISPID_SVEAudioLevel',
    'SREAllEvents', 'SpeechFormatType', 'eLEXTYPE_RESERVED8',
    'SRAONone', 'ISpeechTextSelectionInformation',
    ...
    'ISpeechGrammarRuleStateTransitions', 'SAFT12kHz16BitStereo',
    'DISPID_SPILanguageId', 'SPCATEGORYTYPE',
    'SREPropertyStringChange', 'ISpeechGrammarRuleStateTransition',
    'SSFMCreateForWrite', 'DISPID_SPIRetainedSizeBytes',
    'SPWAVEFORMATTYPE', 'eLEXTYPE_PRIVATE5', 'DISPID_SPRulesItem',
    'ISequentialStream', 'DISPID_SpeechPhraseProperties',
    'DISPID_SPIProperties', 'DISPID_SRState', 'SRESoundStart',
    'ISpeechWaveFormatEx', 'SPWF_INPUT', 'SPSUnknown',
    'SAFT24kHz8BitStereo', 'SPXMLRESULTOPTIONS',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SpeechTokenKeyUI', 'SpeechCategoryVoices',
    'DISPID_SRCRetainedAudioFormat', 'SPINTERFERENCE_TOOLOUD',
    'DISPID_SRRSaveToMemory', 'SpeechRecognizerState', 'SPVPRI_OVER',
    'SPPHRASEELEMENT', 'SPEI_PHRASE_START', 'DISPID_SPEs_NewEnum',
    'SpeechDataKeyLocation', 'SAFTDefault',
    'DISPID_SLGetPronunciations', 'SVEAllEvents',
    'DISPID_SRCVoicePurgeEvent', 'SVP_1', 'SRATopLevel',
    'ISpeechAudioFormat', 'DISPID_SPPs_NewEnum', 'DISPID_SPAsCount',
    'DISPID_SpeechLexiconProns', 'SPEI_RECOGNITION',
    'DISPID_SRSAudioStatus', 'DISPID_SpeechRecoResult2',
    'DISPID_SABIMinNotification', 'DISPID_SWFEBitsPerSample',
    'SpeechTokenContext', 'SPSERIALIZEDRESULT',
    'SPEI_SR_RETAINEDAUDIO', 'SAFT32kHz8BitStereo', 'SPRULE',
    'SRSActive', 'SpeechRecoEvents', 'DISPID_SPEsItem', 'SPPS_Verb',
    'SAFT48kHz16BitMono', 'SVP_4', 'ISpeechPhraseProperty',
    'DISPID_SDKDeleteKey', 'STSF_CommonAppData',
    'DISPID_SPEAudioTimeOffset', 'DISPID_SpeechAudioStatus',
    'SPPHRASEPROPERTY', 'SRSInactive', 'SRERecoOtherContext',
    'DISPIDSPTSI_SelectionOffset', 'DISPID_SpeechXMLRecoResult',
    'DISPID_SOTDisplayUI', 'DISPID_SPRNumberOfElements',
    'DISPID_SpeechLexicon', 'DISPID_SPANumberOfElementsInResult',
    'DISPID_SPRules_NewEnum', 'SVSFlagsAsync', 'SPEI_SOUND_END',
    'DISPID_SVAlertBoundary', 'STSF_AppData',
    'SAFTCCITT_uLaw_22kHzStereo', 'DISPIDSPTSI', 'SREInterference',
    'SDKLCurrentConfig', 'SREAudioLevel', 'tagSPPROPERTYINFO',
    'SVPOver', 'DISPID_SRRGetXMLResult', 'SAFTCCITT_uLaw_44kHzStereo',
    'DISPID_SMSGetData', 'DISPID_SRIsShared', 'SAFT24kHz16BitMono',
    'DISPID_SPRuleConfidence', 'eWORDTYPE_ADDED',
    'DISPID_SPPBRestorePhraseFromMemory',
    'DISPID_SOTMatchesAttributes', 'SPGS_ENABLED', 'SRAInterpreter',
    'DISPID_SRProfile', 'SpeechEngineProperties', 'SAFT8kHz8BitMono',
    'SPAS_STOP', 'SP_VISEME_2', 'SGDSActiveWithAutoPause',
    'SPEI_RECO_STATE_CHANGE', 'SPSHORTCUTPAIR',
    'DISPID_SRRDiscardResultInfo', 'eLEXTYPE_PRIVATE16',
    'DISPID_SPERetainedSizeBytes', 'SECNormalConfidence',
    'SPRST_INACTIVE', 'eLEXTYPE_LETTERTOSOUND', 'ISpeechFileStream',
    'SPCS_ENABLED', 'SVSFNLPSpeakPunc',
    'DISPID_SpeechRecoContextEvents', 'ISpeechPhraseReplacement',
    'SRESoundEnd', 'SP_VISEME_12', 'eLEXTYPE_RESERVED4',
    'DISPID_SRGetPropertyNumber', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'DISPID_SpeechObjectToken', 'SPLO_STATIC', 'SP_VISEME_0',
    'SAFTText', 'DISPID_SPAs_NewEnum', 'DISPID_SDKCreateKey',
    'ISpeechPhraseElements', 'DISPID_SGRsCommitAndSave',
    'SPVOICESTATUS', 'SAFT11kHz16BitStereo', 'DISPID_SVSVisemeId',
    'SECLowConfidence', 'DISPID_SPPValue', 'SPBINARYGRAMMAR',
    'DISPID_SLWLangId', 'SPRULESTATE', 'DISPID_SGRAddResource',
    'SpeechSpecialTransitionType', 'SpeechDiscardType',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'DISPID_SRRTLength',
    'SPBO_NONE', 'DISPID_SRCreateRecoContext', 'SBOPause',
    'SPEI_RESERVED5', 'SpeechPropertyComplexResponseSpeed',
    'DISPID_SOTIsUISupported', 'DISPID_SPIGrammarId',
    'DISPID_SOTSetId', 'DISPID_SPIGetDisplayAttributes',
    'DISPID_SpeechAudioFormat', 'SRARoot', 'DISPID_SGRAddState',
    'SECFDefault', 'SpeechRegistryLocalMachineRoot',
    'SPEI_TTS_BOOKMARK', 'SRADynamic', 'ISpeechPhraseElement',
    'STCInprocServer', 'DISPID_SDKSetBinaryValue',
    'SpeechEngineConfidence', 'Speech_StreamPos_Asap',
    'DISPID_SREmulateRecognition', 'DISPID_SVSCurrentStreamNumber',
    'SVEPhoneme', 'DISPID_SRRTimes', 'DISPID_SDKEnumKeys',
    'eLEXTYPE_PRIVATE9', 'eLEXTYPE_PRIVATE19', 'SECHighConfidence',
    'SPINTERFERENCE_NONE', 'DISPID_SPCLangId', 'SPEI_WORD_BOUNDARY',
    'SECFIgnoreWidth', 'ISpRecoContext', 'SREStreamStart',
    'SGSExclusive', 'DISPID_SRRTStreamTime', 'SPSMF_UPS',
    'SpTextSelectionInformation', 'DISPID_SRRPhraseInfo',
    'SPLOADOPTIONS', 'DISPID_SASState', 'DISPIDSPRG',
    'DISPID_SPPNumberOfElements', 'DISPID_SGRSTsItem',
    'SAFTCCITT_ALaw_44kHzMono', 'DISPID_SABIEventBias',
    'DISPID_SpeechLexiconPronunciation', 'DISPID_SVRate', 'SVP_12',
    'SpSharedRecognizer', 'DISPID_SpeechVoice',
    'DISPID_SVGetAudioInputs', 'eLEXTYPE_USER', 'ISpeechAudio',
    'SVP_3', 'DISPID_SGRsItem', 'DISPID_SRCPause',
    'SpeechCategoryAudioOut', 'WAVEFORMATEX', 'SPTEXTSELECTIONINFO',
    'SpeechBookmarkOptions', 'DISPID_SPPsItem', 'STCInprocHandler',
    'DISPID_SVGetProfiles', 'DISPID_SPRs_NewEnum', 'SPAO_NONE',
    'Speech_Max_Word_Length', 'SPGS_EXCLUSIVE',
    'DISPID_SRSNumberOfActiveRules', 'SpeechAudioFormatGUIDText',
    'IStream', 'SAFTNonStandardFormat', 'SPGRAMMARSTATE', 'SPWORD',
    'SVSFParseSsml', 'DISPID_SRGCmdLoadFromResource', 'eLEXTYPE_APP',
    'SpeechVoiceCategoryTTSRate', 'DISPID_SGRSTText',
    'SAFT44kHz8BitStereo', 'SPSHT_NotOverriden',
    'DISPID_SRRAudioFormat', 'DISPID_SLPSymbolic',
    'eLEXTYPE_PRIVATE7', 'DISPID_SRGSetTextSelection', 'SASPause',
    'ISpeechRecognizerStatus', 'SPEI_START_SR_STREAM',
    'SPSTREAMFORMATTYPE', 'SVSFVoiceMask', 'SVP_10',
    'SAFT32kHz16BitStereo', 'SpeechRuleAttributes',
    'DISPID_SLPsCount', 'DISPID_SRRTTickCount', 'SPPS_Function',
    'SSSPTRelativeToEnd', 'DISPID_SRCRequestedUIType',
    'DISPID_SRCEEnginePrivate', 'SPINTERFERENCE_TOOFAST',
    'SpSharedRecoContext', 'SREHypothesis', 'SpeechAudioFormatType',
    'SpeechPropertyLowConfidenceThreshold',
    'SpeechPropertyAdaptationOn', 'DISPID_SVSInputWordPosition',
    'DISPID_SLWWord', 'SAFT16kHz16BitStereo', 'DISPID_SABIBufferSize',
    'DISPID_SVEWord', 'ISpRecoResult', 'DISPID_SVDisplayUI',
    'SVSFIsFilename', '__MIDL_IWinTypes_0009', 'SpStream',
    'SPEI_RESERVED6', 'DISPID_SPIGetText', 'DISPID_SRCERecognition',
    'ISpSerializeState', 'DISPID_SRGDictationUnload',
    'SpeechAddRemoveWord', 'DISPID_SRSCurrentStreamNumber',
    'DISPID_SRGetRecognizers', 'SPVPRI_NORMAL', 'DISPID_SOTCDefault',
    'SPSSuppressWord', 'SRAORetainAudio', 'SAFT8kHz16BitMono',
    'SDA_Two_Trailing_Spaces', 'SASStop', 'DISPID_SRCBookmark',
    'SpeechTokenIdUserLexicon', 'SP_VISEME_8', 'DISPID_SRCEEndStream',
    'SAFT48kHz8BitStereo', 'SPEI_MAX_SR', 'SSTTDictation',
    'SVSFParseAutodetect', 'DISPID_SpeechBaseStream',
    'SPEI_HYPOTHESIS', 'SpeechTokenValueCLSID',
    'SpUnCompressedLexicon', 'ISpeechGrammarRule', 'SPLO_DYNAMIC',
    'SAFT22kHz16BitMono', 'SITooQuiet', 'DISPID_SPEActualConfidence',
    'DISPID_SLPType', 'SAFT11kHz16BitMono', 'SVPAlert',
    'SP_VISEME_16', 'DISPID_SPRDisplayAttributes', 'SpFileStream',
    'DISPID_SVSpeakStream', 'SpNullPhoneConverter',
    'DISPID_SpeechPhraseReplacement', 'ISpeechGrammarRuleState',
    'SAFTCCITT_ALaw_22kHzMono', 'eLEXTYPE_PRIVATE18',
    'SAFTCCITT_uLaw_8kHzMono', 'DISPID_SGRsFindRule',
    'DISPID_SRDisplayUI', 'DISPID_SLAddPronunciationByPhoneIds',
    'DISPID_SpeechPhoneConverter', 'DISPID_SRSClsidEngine',
    'SPRST_ACTIVE_ALWAYS', 'DISPID_SpeechFileStream', 'ISpVoice',
    'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'SpeechRecoContextState', 'DISPID_SPARecoResult',
    'ISpPhoneticAlphabetSelection', 'SpLexicon', 'SpPhoneConverter',
    'SPEI_MIN_SR', 'ISpRecoCategory', 'ISpeechPhraseRules',
    'DISPID_SPIRule', 'ISpeechRecoResultTimes', 'SRSEDone',
    'DISPID_SpeechAudio'
]
